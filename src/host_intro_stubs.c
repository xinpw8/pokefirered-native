...
u32 gHostIntroStubInitWindowsCalls = 0;
u32 gHostIntroStubFillWindowPixelBufferCalls = 0;
u32 gHostIntroStubBlitBitmapToWindowCalls = 0;
u32 gHostIntroStubPutWindowTilemapCalls = 0;
u32 gHostIntroStubCopyWindowToVramCalls = 0;
...
void HostIntroStubReset(void)
{
    ...
    gHostIntroStubInitWindowsCalls = 0;
    gHostIntroStubFillWindowPixelBufferCalls = 0;
    gHostIntroStubBlitBitmapToWindowCalls = 0;
    gHostIntroStubPutWindowTilemapCalls = 0;
    gHostIntroStubCopyWindowToVramCalls = 0;
